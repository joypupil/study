...
public class SignProvider {
	...
	public static boolean verify(byte[] pubKeyText, String plainText, byte[] signText) {
		try {
			...
			X509EncodedKeySpec bobPubKeySpec = new X509EncodedKeySpec(decoder.decodeBuffer(new String(pubKeyText)));
			// RSA对称加密算法
			...
			byte[] signed = decoder.decodeBuffer(new String(signText));
